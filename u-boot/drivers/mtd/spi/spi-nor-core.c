...
//	printf("#spi_nor_read_reg,code 0x%x,val 0x%x\n",code,*val);
...
{
//	printf("spi_nor_write_reg,opcode = 0x%x\n",opcode);
...
static ssize_t spi_nor_write_data(struct spi_nor *nor, loff_t to, size_t len,
				  const u_char *buf)
{
//	printf("#spi_nor_write_data,cmd 0x%x\n",nor->program_opcode);
...
{
//	printf("spi_nor_erase_sector cmd 0x%x,width %d, at 0x%llx\n", nor->erase_opcode,nor->addr_width,addr);
