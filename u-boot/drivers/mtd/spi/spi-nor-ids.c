...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("gd25b256e", 0xc84019, 0, 64 * 1024,   512, SECT_4K | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_4B_OPCODES) },	
	{ INFO("gd25s513md", 0xc84019, 0, 64 * 1024,   1024, SECT_4K | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_4B_OPCODES) },	

	{ INFO("gd25B512me", 0xc8471a, 0, 64 * 1024,   1024, SECT_4K | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_4B_OPCODES) },				
#endif
	...
	{ INFO("fm25q128", 0xa14018, 0, 64 * 1024,   256, SPI_NOR_QUAD_READ | SECT_4K) },			
	...
	{ INFO6("mt25qu512a",  0x20bb20, 0x104400, 64 * 1024, 1024, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_4B_OPCODES | USE_FSR) },
	...
	{
		INFO("w25q128jv0", 0xef4018, 0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB)
	},
	{
		INFO("w25q256jv", 0xef4019, 0, 64 * 1024, 512,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB)
	},	
	{
	...
	{ INFO("w25q512jv", 0xef4020, 0, 64 * 1024, 1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ
	 | SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB|SPI_NOR_4B_OPCODES) },
#endif
