...
static __always_inline s64 atomic64_inc(const atomic64_t *v)
{
	WRITE_ONCE(v->counter, (s64)(v->counter+1));
}

static __always_inline s64 atomic64_dec(const atomic64_t *v)
{
	WRITE_ONCE(v->counter, (s64)(v->counter-1));
}
/*
...
{
	WRITE_ONCE(v->counter, (s64)(v->counter+i));
}
