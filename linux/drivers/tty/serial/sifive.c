...
#define SIFIVE_SERIAL_TXCTRL_TXCNT_MASK		(0xf << SIFIVE_SERIAL_TXCTRL_TXCNT_SHIFT)
#define SIFIVE_SERIAL_TXCTRL_NSTOP_SHIFT	1
#define SIFIVE_SERIAL_TXCTRL_NSTOP_MASK		(3 << SIFIVE_SERIAL_TXCTRL_NSTOP_SHIFT)
...
#define SIFIVE_SERIAL_RXCTRL_RXCNT_MASK		(0xf << SIFIVE_SERIAL_TXCTRL_TXCNT_SHIFT)
...
/* SETUP */
#define SIFIVE_SERIAL_SETUP_OFFS		0x20
#define SIFIVE_SERIAL_SETUP_PARITY_EN_SHIFT		0x0
#define SIFIVE_SERIAL_SETUP_PARITY_EN_MASK		(0x1 << SIFIVE_SERIAL_SETUP_PARITY_EN_SHIFT)
#define SIFIVE_SERIAL_SETUP_PARITY_SEL_SHIFT	0x1
#define SIFIVE_SERIAL_SETUP_PARITY_SEL_MASK		(0x1 << SIFIVE_SERIAL_SETUP_PARITY_SEL_SHIFT)
#define SIFIVE_SERIAL_SETUP_CLR_FIFO_SHIFT		0x3
#define SIFIVE_SERIAL_SETUP_CLR_FIFO_MASK		(0x1 << SIFIVE_SERIAL_SETUP_CLR_FIFO_SHIFT)
#define SIFIVE_SERIAL_SETUP_BIT_LENTH_SHIFT		0x4
#define SIFIVE_SERIAL_SETUP_BIT_LENTH_MASK		(0x7 << SIFIVE_SERIAL_SETUP_BIT_LENTH_SHIFT)
/*
 * Config macros
 */
...
static int sifive_serial_probe(struct platform_device *pdev)
{
	...
	/* setup serial */
	__ssp_writel(((0 << SIFIVE_SERIAL_SETUP_PARITY_EN_SHIFT) & SIFIVE_SERIAL_SETUP_PARITY_EN_MASK) |
			     ((0 << SIFIVE_SERIAL_SETUP_PARITY_SEL_SHIFT)& SIFIVE_SERIAL_SETUP_PARITY_SEL_MASK) |
			     ((3 << SIFIVE_SERIAL_SETUP_BIT_LENTH_SHIFT) & SIFIVE_SERIAL_SETUP_BIT_LENTH_MASK),
		     SIFIVE_SERIAL_SETUP_OFFS, ssp);
